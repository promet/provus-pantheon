This module provides a way of configuring display modes for any kind of node
without creating a config file for each view mode on each node type.  This makes
the development process easier when developing a set of card styles that
Provus makes use of.
